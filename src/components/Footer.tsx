        ...
        <div className="footer-main grid-4">
          ...
          <div className="footer-brand-col">
            ...
            <div className="footer-social-links">
              <a href="https://www.linkedin.com/company/alphazox/" className="social-link" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              ...
              <a href="https://x.com/Alphazox" className="social-link" target="_blank" rel="noopener noreferrer" aria-label="Twitter / X">
              ...
              <a href="https://www.instagram.com/alphazox_?utm_source=qr&igsh=MTRqZmhyeWY0NG50MA==" className="social-link" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
